...
Future<QuerySnapshot<Map<String, dynamic>>> getUsersWithFavorisRecipe() async {
  print('test');
  return await FirebaseFirestore.instance.collection('users').where('favorisRecettes', isGreaterThan: []).get();
}
