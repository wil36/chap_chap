                                                          ...
                                                          children: [
                                                            Row(
                                                              children: [
                                                                ...
                                                                ToggleIcon(
                                                                  onPressed: () async {
                                                                    reviews[index]['likes'].contains(currentUserUid) ? await unlikeComment(reviews[index].id) : await likeComment(reviews[index].id);
                                                                    setState(() {});
                                                                  },
                                                                  value: reviews[index]['likes'].contains(currentUserUid),
