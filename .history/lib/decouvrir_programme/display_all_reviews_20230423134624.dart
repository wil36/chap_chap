...
class DisplayAllReviews extends StatefulWidget {
  final DocumentReference programmeId;
  DisplayAllReviews({
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            StreamBuilder(
                stream: getAllRecipeComments(widget.programmeId),
                                                                                          ...
                                                                                          children: [
                                                                                            Row(
                                                                                              ...
                                                                                              children: [
                                                                                                ...
                                                                                                Text(
                                                                                                  reply['date'].toDate().toString().substring(0, 10),
                                                                                                  style: MizzUpTheme.bodyText1.override(
                                                                                                    color: Colors.black,
                                                                                                    fontFamily: 'IBM',
                                                                                                    fontSize: 12,
...
Stream<QuerySnapshot<Map<String, dynamic>>> getAllProgrammeReviews(DocumentReference programmeId) {
  return FirebaseFirestore.instance.collection('comments').where('programme_id', isEqualTo: programmeId).snapshots();
}
