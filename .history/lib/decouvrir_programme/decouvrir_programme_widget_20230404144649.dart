...
class DecouvrirProgrammeWidget extends StatefulWidget {
  ...
  @override
  _DecouvrirProgrammeWidgetState createState() => _DecouvrirProgrammeWidgetState();
}

class _DecouvrirProgrammeWidgetState extends State<DecouvrirProgrammeWidget> {
  final scaffoldKey = GlobalKey<ScaffoldState>();

  List<String> isUpImage = ['assets/programmes/chapchap.jpg', 'assets/programmes/decouverte.jpg', 'assets/programmes/pousse.jpg', 'assets/programmes/transition.jpg'];
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MizzUpIconButton(
                      borderColor: const Color(0xFFF2D0BD),
                      borderRadius: 20,
                      buttonSize: 40,
                          ...
                          Padding(
                            ...
                            child: Material(
                              ...
                              child: Container(
                                ...
                                decoration: const BoxDecoration(),
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(25, 2, 10, 0),
                                  child: StreamBuilder<List<ProgrammesRecord?>>(
                                    stream: queryProgrammesRecord(
                                      queryBuilder: (programmesRecord) => programmesRecord.orderBy('create_time', descending: true),
                                      limit: 10,
                                    ),
                                    builder: (context, snapshot) {
                                      ...
                                      List<ProgrammesRecord?> wrapProgrammesRecordList = snapshot.data!;
                                      return Wrap(
                                        spacing: 0,
                                        runSpacing: 0,
                                        ...
                                        children: List.generate(wrapProgrammesRecordList.length, (wrapIndex) {
                                          final wrapProgrammesRecord = wrapProgrammesRecordList[wrapIndex]!;
                                          return StreamBuilder<ProgrammesRecord?>(
                                            stream: ProgrammesRecord.getDocument(wrapProgrammesRecord.reference!),
                                            builder: (context, snapshot) {
                                              // Customize what your widget looks like when it's loading.
                                              if (!snapshot.hasData) {
                                                return const Center(
                                                    ...
                                                    await Navigator.push(
                                                      ...
                                                      MaterialPageRoute(
                                                        builder: (context) => FicheProgrammeWidget(
                                                          detailsProgramme: containerProgrammesRecord,
                                                        ),
                                                      ),
                                                    );
                                                  },
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          containerProgrammesRecord.titre!,
                                                      ...
                                                      Padding(
                                                        padding: const EdgeInsetsDirectional.fromSTEB(5, 5, 35, 0),
                                                        child: Text(
                                                          containerProgrammesRecord.sousTitre!,
                                                          style: MizzUpTheme.bodyText1.override(
                                                            fontFamily: 'IBM',
                                                            color: Colors.black,
                                                            fontSize: 11,
                                                      ...
                                                      Container(
                                                        ...
                                                        child: Stack(
                                                          children: [
                                                            ...
                                                            Visibility(
                                                              visible: containerProgrammesRecord.free == false,
                                                              child: Align(
