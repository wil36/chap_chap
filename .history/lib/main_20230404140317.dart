...
class _NavBarPageState extends State<NavBarPage> {
  ...
  final screen = [const DecouvrirProgrammeWidget(), const RecettesWidget(), const PagedaccueilWidget(), const WebviewWidget(), const ProfilWidget(), const PagedaccueilWidget()];
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          Navigator.pushReplacement(
            context,
            PageRouteBuilder(
              pageBuilder: (context, animation1, animation2) => NavBarPage(index: 5),
      ...
      body: Padding(padding: const EdgeInsetsDirectional.fromSTEB(0, 40, 0, 0), child: screen[_index]),
