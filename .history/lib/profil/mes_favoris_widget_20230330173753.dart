                                ...
                                child: Padding(
                                  ...
                                  child: StreamBuilder<List<UsersRecord?>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return Builder(
                                        builder: (context) {
                                          final favoriteRecettes =
                                              rowUsersRecord!.favorisRecettes!
                                                  .toList()
                                                  .toList();
                                          ...
                                          return SingleChildScrollView(
                                            ...
                                            child: Row(
                                              ...
                                              children: List.generate(
                                                  favoriteRecettes.length,
                                                  (favoriteRecettesIndex) {
                                                final favoriteRecettesItem =
                                                    favoriteRecettes[
                                                        favoriteRecettesIndex];
                                                return Padding(
                                                  padding:
                                                  ...
                                                  child: StreamBuilder<
                                                      RecettesRecord?>(
                                                    stream: RecettesRecord
                                                        .getDocument(
                                                            favoriteRecettesItem),
                                                    builder:
                                                        (context, snapshot) {
                                                      // Customize what your widget looks like when it's loading.
                                                      if (!snapshot.hasData) {
                                                          ...
                                                          await Navigator.push(
                                                            ...
                                                            MaterialPageRoute(
                                                              builder: (context) =>
                                                                  RecetteSuite2Widget(
                                                                  description:
                                                                            columnRecettesRecord.description!,
                                                                        dureePrepa:
                                                                            columnRecettesRecord.dureePrepa!,
                                                                        etapes:
                                                                            columnRecettesRecord.etapes!,
                                                                        listeIngredients:
                                                                            columnRecettesRecord.listeIngredients!,
                                                                        niveauDifficulte:
                                                                            columnRecettesRecord.niveauDifficulte!,
                                                                        photoPrincipale:
                                                                            columnRecettesRecord.photoPrincipale!,
                                                                        titre: columnRecettesRecord
                                                                            .titre!,
                                                                        nbIngredients:
                                                                            columnRecettesRecord.nbIngredients!,
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        value: rowUsersRecord
                                                                            .favorisArticles!
                                                                            .toList()
                                                                            .contains(columnArticlesRecord.reference),
                                                                        onIcon:
                                                                            const Icon(
                                                                          Icons
                                                                              .favorite_sharp,
