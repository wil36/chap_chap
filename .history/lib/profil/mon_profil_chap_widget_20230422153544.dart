            ...
            builder: (context, snapshot) {
              ...
              return Column(
                ...
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        FlutterSwitch(
                          ...
                          valueFontSize: 25.0,
                          toggleSize: 20.0,
                          value: currentUserDocument!.isPrivate,
                          borderRadius: 30.0,
                          showOnOff: false,
                          onToggle: (val) {
                            setState(() {
                              currentUserDocument!.isPrivate = val;
                            });
                          },
                        ),
                      ],
                  ...
                  SizedBox(height: 20),
                  Text('Si tu passes ton profil en mode privé, tu ne pourras pas commenter ou répondre aux commentaires disponibles sous les recettes'),
                  SizedBox(height: 20),
                  TextButton(
                    onPressed: () async {
                    ...
                    child: Container(
                        ...
                        child: const Text('Enregistrer mes préférences', style: TextStyle(color: Colors.black, fontSize: 20))),
                  ),
                ],
              );
            },
