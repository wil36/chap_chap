            ...
            builder: (context, snapshot) {
              ...
              return Column(
                ...
                children: [
                  ...
                  editProfileInfosFormField(userNameController, currentUserDisplayName, 'Nom d\'utilisateur'),
                  GestureDetector(
                      onTap: () async {
                      ...
                      child: editProfileInfosFormField(hairTypeController, hairTypes[columnCheveuxUserRecord!.styleCheveux!], 'Type de cheveux')),
                  editProfileInfosFormField(hairObjectiveController, hairObjectives[columnCheveuxUserRecord!.routineCapillaire!], 'Objectif capilaire'),
                  editProfileInfosFormField(instagramController, 'Instagram', 'Instagram'),
                  editProfileInfosFormField(tikTokController, 'TikTok', 'TikTok'),
                  editProfileInfosFormField(bioController, 'Bio', 'Bio'),
                  // Padding(
