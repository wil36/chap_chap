                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          child: Column(
                            mainAxisSize: MainAxisSize.max,
                            children: [
                              editProfileInfosFormField(textController1, 'Nom d\'utilisateur', 'Nom d\'utilisateur'),
                              editProfileInfosFormField(textController1, 'Type de cheveux', 'Type de cheveux'),
                              editProfileInfosFormField(textController1, 'Objectif capilaire', 'Objectif capilaire'),
                              editProfileInfosFormField(textController1, 'Instagram', 'Instagram'),
                              editProfileInfosFormField(textController1, 'TikTok', 'TikTok'),
                              editProfileInfosFormField(textController1, 'Bio', 'Bio'),
                              Padding(
