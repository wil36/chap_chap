              ...
              builder: (context, snapshot) {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 20),
                    Text(textAlign: TextAlign.center, 'Si tu passes ton profil en mode privé, tu ne pourras pas commenter ou répondre aux commentaires disponibles sous les recettes'),
                    SizedBox(height: 20),
                    TextButton(
                      onPressed: () async {
