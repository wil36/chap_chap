                ...
                Padding(
                  ...
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(textAlign: TextAlign.center, 'Estelle Coudert', style: TextStyle(fontSize: 24.0, fontWeight: FontWeight.bold, fontFamily: 'Montserrat')),
                          SizedBox(height: 10),
                          Text(
...
numquam blanditii'''),
                          Row(
                            children: [
                              Container(child: Icon(Icons.tiktok, color: MizzUpTheme.primaryColor)),
                              SvgPicture.asset('assets/profil/instagram_logo.svg'),
                            ],
                          ),
                        ],
                      )),
