...
class _MonProfilChapWidgetState extends State<MonProfilChapWidget> {
            ...
            builder: (context, snapshot) {
              ...
              return Column(
                ...
                children: [
                  ...
                  editProfileInfosFormField(userNameController, currentUserDisplayName, 'Nom d\'utilisateur', null),
                  GestureDetector(
                      onTap: () async {
                      ...
                      child: editProfileInfosFormField(hairTypeController, hairTypes[columnCheveuxUserRecord!.styleCheveux!], 'Type de cheveux', null)),
                  editProfileInfosFormField(hairObjectiveController, hairObjectives[columnCheveuxUserRecord!.routineCapillaire!], 'Objectif capilaire', null),
                  editProfileInfosFormField(instagramController, 'Instagram', 'Instagram', null),
                  editProfileInfosFormField(tikTokController, 'TikTok', 'TikTok', null),
                  editProfileInfosFormField(bioController, 'Bio', 'Bio', null),
                  // Padding(
  ...
  Widget editProfileInfosFormField(TextEditingController controller, String hintText, String helperText, void Function()? onTap) {
    return Container(
