...
class _MonProfilChapWidgetState extends State<MonProfilChapWidget> {
              ...
              return Column(
                ...
                children: [
                  ...
                  GestureDetector(
                      ...
                      child: editProfileInfosFormField(hairTypeController, hairTypes[columnCheveuxUserRecord!.styleCheveux!], 'Type de cheveux',  await showModalBottomSheet(
  ...
  Widget editProfileInfosFormField(TextEditingController controller, String hintText, String helperText, Future<void> Function()? onTap) {
    return Container(
