        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                Container(margin: const EdgeInsets.only(left: 10), child: Icon(Icons.arrow_back)),
                Icon(Icons.settings),
              ],
            ),
            Stack(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          Navigator.push(
                                              context,
                                              PageTransition(
                                                  type: PageTransitionType.fade, duration: Duration(milliseconds: 500), reverseDuration: Duration(milliseconds: 500), child: PreniumWidget()));
                                        },
