                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            suffixIcon: hairTypeController.text.isEmpty
                                ? InkWell(
                                    onTap: () => hairTypeController.clear(),
                                    child: const Icon(
                                      Icons.edit,
                                      color: MizzUpTheme.primaryColor,
                                      size: 20,
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            suffixIcon: hairObjectiveController.text.isEmpty
                                ? InkWell(
                                    onTap: () => hairObjectiveController.clear(),
                                    child: const Icon(
                                      Icons.edit,
                                      color: MizzUpTheme.primaryColor,
                                      size: 20,
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: instagramController.text.isEmpty
                                ? InkWell(
                                    onTap: () => instagramController.clear(),
                                    child: const Icon(
                                      Icons.edit,
                                      color: MizzUpTheme.primaryColor,
                                      size: 20,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      FlutterSwitch(
                        ...
                        activeSwitchBorder: Border.all(color: MizzUpTheme.primaryColor),
                        inactiveColor: Colors.transparent,
                        inactiveSwitchBorder: Border.all(color: MizzUpTheme.secondaryColor),
                        activeToggleColor: MizzUpTheme.secondaryColor,
                        inactiveToggleColor: MizzUpTheme.secondaryColor,
                        activeToggleBorder: Border.all(color: MizzUpTheme.secondaryColor),
                        inactiveToggleBorder: Border.all(color: MizzUpTheme.secondaryColor),
                        width: 125.0,
                        height: 55.0,
                        valueFontSize: 25.0,
                        toggleSize: 45.0,
                      ...
                      Switch(
                        ...
                        activeTrackColor: MizzUpTheme.primaryColor,
                        activeColor: MizzUpTheme.secondaryColor,
                      ),
                    ],
                  ),
                  TextButton(
