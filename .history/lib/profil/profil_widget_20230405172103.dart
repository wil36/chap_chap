...
import '../components/create_recette_article_widget.dart';
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    await Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => const MonProfilChapWidget(),
                                      ),
                                    );
                                  },
                                  child: Row(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Align(
                                          alignment: AlignmentDirectional(0, 0),
                                          child: Image.asset('assets/profil/saved_recipe_icon.png', width: 10, height: 15),
                                        ),
                                      ),
                                      Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(10, 0, 0, 0),
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    await Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => const MonProgramWidget(),
                                      ),
                                    );
                                  },
                                  child: Row(
                                  ...
                                  child: InkWell(
                                    onTap: () async {
                                      await Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => const RappelWidget(),
                                        ),
                                      );
                                    },
                                    child: Row(
                                  ...
                                  child: InkWell(
                                    onTap: () async {
                                      await Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => const AProposWidget(),
                                        ),
                                      );
                                    },
                                    child: Row(
                                          ...
                                          builder: (context) {
                                            return Padding(
                                              ...
                                              child: SizedBox(
                                                ...
                                                child: const CreateRecetteArticleWidget(),
                                              ),
                                            );
                                          },
                                        );
