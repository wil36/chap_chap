...
class _MonProgramWidgetState extends State<MonProgramWidget> {
  ...
  DocumentReference semaineSpecial0 = FirebaseFirestore.instance.collection('detailsWeekProg').doc('HrB5csYvIUaIGytdhVl0');
  DocumentReference semaineSpecial1 = FirebaseFirestore.instance.collection('programmes').doc('0nDyRIL1Qg9u90Vzt5Ho');
  DocumentReference semaineSpecial2 = FirebaseFirestore.instance.collection('programmes').doc('BFUA4QdhoxRMdAReXPyh');
  DocumentReference semaineSpecial3 = FirebaseFirestore.instance.collection('programmes').doc('TMqv6WGZkkMDh6nik4JB');
                      ...
                      if (currentUserDocument?.progRef == semaineSpecial1)
                        AuthUserStreamWidget(
                          child: StreamBuilder<ProgrammesRecord?>(
                            stream: ProgrammesRecord.getDocument(currentUserDocument!.progRef!),
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await Navigator.pushAndRemoveUntil(
                                    context,
                                    MaterialPageRoute(builder: (context) => const NavBarPage(index: 0)),
                                    (r) => false,
                                  );
                                },
