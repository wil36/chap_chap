                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          child: Column(
                            mainAxisSize: MainAxisSize.max,
                            children: [
                              editProfileInfosFormField(textController1, 'Nom d\'utilisateur', 'Test'),
                              editProfileInfosFormField(textController1, 'Type de cheveux', 'Test'),
                              editProfileInfosFormField(textController1, 'Objectif capilaire', 'Test'),
                              editProfileInfosFormField(textController1, 'Instagram', 'Test'),
                              editProfileInfosFormField(textController1, 'TikTok', 'Test'),
                              editProfileInfosFormField(textController1, 'Bio', 'Test'),
                              Padding(
