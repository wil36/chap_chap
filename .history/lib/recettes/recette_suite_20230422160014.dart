...
class _RecetteSuiteWidgetState extends State<RecetteSuiteWidget> {
  ...
  getRecipeLikes(List<DocumentReference<Object?>> documentReference) {
    return FirebaseFirestore.instance.collection('likes').where('recette', isEqualTo: documentReference).snapshots();
  }
}
