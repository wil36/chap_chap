    ...
    return ListView(
      ...
      children: [
        ...
        StreamBuilder<Object>(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                List<QueryDocumentSnapshot<Map<String, dynamic>>> documents = snapshot.data as List<QueryDocumentSnapshot<Map<String, dynamic>>>;
                return Column(
                  children: [
                    for (DocumentSnapshot<Map<String, dynamic>> document in documents)
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              child: Center(
                                child: Text(
                                  document.data()!['Prenom'][0].toString().toUpperCase() + document.data()!['Nom'][0].toString().toUpperCase(),
                                  style: MizzUpTheme.bodyText1.override(
                                    color: Colors.white,
                                    fontFamily: 'IBM',
                                    fontSize: 12,
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    document.data()!['Prenom'] + ' ' + document.data()!['Nom'],
                                    style: MizzUpTheme.bodyText1.override(
                                      color: Colors.black,
                                      fontFamily: 'IBM',
                                      fontSize: 14,
...
Stream<QuerySnapshot> getAllRecipeComments(DocumentReference recipeId) {
  return FirebaseFirestore.instance.collection('comments').where('recipeId', isEqualTo: recipeId).snapshots();
}
