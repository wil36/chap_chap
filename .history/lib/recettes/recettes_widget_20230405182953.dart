                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: ToggleIcon(
                                                            onPressed: () async {
                                                              ...
                                                              await FirebaseFirestore.instance.collection('recettes').doc(pageViewRecettesRecord.reference!.id).update({
                                                                'favoris': FieldValue.increment(currentUserDocument!.favorisRecettes!.toList().contains(favorisRecettesElement) ? -1 : 1),
                                                              });
                                              ...
                                              await Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                  builder: (context) => RecetteSuiteWidget(
                                                    ...
                                                    recetteVisibleRef: RecetteRef.masqueProteine,
