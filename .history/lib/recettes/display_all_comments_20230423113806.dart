...
Stream<QuerySnapshot> getCommentReplies(String commentId) {
  var formattedCommentId = commentId.split('/')[1];
  return FirebaseFirestore.instance.collection('comments_reply').where('comment_id', isEqualTo: formattedCommentId).snapshots();
}
