...
class _RecetteSuiteWidgetState extends State<RecetteSuiteWidget> {
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>> getUsers = getUsersWithFavorisRecipe();
                      ...
                      for (DocumentSnapshot doc in documents) {
                        ...
                        if (favRecipe.contains(streamPremium.reference!)) {
                          ...
                          if (usersInitials.length < 3) {
                            usersInitials.add(doc['Prenom'].toString().substring(0, 1).toUpperCase() + doc['Nom'].toString().substring(0, 1).toUpperCase());
                          }
                        }
                      }
