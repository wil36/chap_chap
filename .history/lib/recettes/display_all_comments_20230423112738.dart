                                                ...
                                                StreamBuilder(
                                                    ...
                                                    builder: ((context, snapshot) {
                                                      if (snapshot.hasData) {
                                                        ...
                                                        return Text(replies.length.toString() + ' réponses');
                                                        return Column(children: [
                                                          for (var reply in replies)
                                                            FutureBuilder(
                                                                future: getUserById(reply['user_id']),
                                                                builder: (context, snapshot) {
                                                                  if (snapshot.hasData) {
                                                                    var user = snapshot.data;
                                                                    return Padding(
...
Stream<QuerySnapshot> getCommentReplies(DocumentReference commentId) {
  return FirebaseFirestore.instance.collection('comments_reply').where('comment_id', isEqualTo: commentId).snapshots();
}
