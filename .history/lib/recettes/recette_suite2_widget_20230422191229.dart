                          ...
                          children: [
                            Container(
                                ...
                                child: Text('Commentaires (${recipeComments.length})',
                                    style: MizzUpTheme.bodyText1.override(fontFamily: 'IBM', color: Colors.black, useGoogleFonts: false, fontWeight: FontWeight.w400, fontSize: 15))),
                            Container(margin: const EdgeInsets.only(right: 40), child: Text('Voir tout')),
                          ],
                        ),
                        SizedBox(height: 10),
                        for (var comment in recipeComments)
                          FutureBuilder(
                            future: getUserById(comment['user_id']),
                            builder: (context, snapshot) {
                              return Padding(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            comment['date'].toDate().toString().substring(0, 10),
                                            style: MizzUpTheme.bodyText1.override(
                                              color: Colors.black,
                                              fontFamily: 'IBM',
                                              fontSize: 12,
