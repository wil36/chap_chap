                                                                ...
                                                                ? Column(children: [
                                                                    for (var reply in replies)
                                                                      FutureBuilder(
                                                                          ...
                                                                          builder: (context, snapshot) {
                                                                            if (snapshot.hasData) {
                                                                              String userPhoto = snapshot.data['photo_url'] != null ? snapshot.data!['photo_url'] : 'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/chap-chap-1137ns/assets/n3ejaipxw085/user-22.jpg';
                                                                              var user = snapshot.data;
                                                                              return Padding(
