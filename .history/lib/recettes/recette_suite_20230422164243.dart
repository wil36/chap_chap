                    ...
                    if (snapshot.hasData) {
                      ...
                      for (DocumentSnapshot doc in documents) {
                        ...
                        if (favRecipe.contains(streamPremium.reference!)) {
                          likesCounter++;
                          doc['photo_url'] != null
                              ? usersPictures.add(Uri.parse(doc['photo_url']))
                              : usersPictures
                                  .add(Uri.parse('https://firebasestorage.googleapis.com/v0/b/mizzup-2f8f5.appspot.com/o/avatars%2Fdefault.png?alt=media&token=8b8b0b0f-0b5a-4b0a-9b0a-8e8b8b0b0b0b'));
                        }
                      }
