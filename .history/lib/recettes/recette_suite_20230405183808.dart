                ...
                child: Container(
                  ...
                  child: ToggleIcon(
                    onPressed: () async {
                      ...
                      final currentRecipe = await FirebaseFirestore.instance.collection('recettes').doc(widget.recetteRef).get();
                      print(currentRecipe.data());
                      // final currentRecipe = await FirebaseFirestore.instance.collection('recettes').doc(widget.recetteRef).get();
                      // final currentRecipeLikes = currentRecipe.data()!['favoris_user_id'];
                      ...
                      // final favorisUserIdRecipe = await FirebaseFirestore.instance.collection('recettes').doc(widget.recetteRef.id).update({
