      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            FutureBuilder(
              future: getUserById(widget.recipesComment.docs[0]['user_id']),
              builder: (context, snapshot) {
                var user = snapshot.data;
                return Column(
                  children: [
                    SizedBox(height: 10),
                    for (int i = 0; i < 5 && i < widget.recipesComment.docs.length; i++)
                      FutureBuilder(
                        future: getUserById(widget.recipesComment.docs[i]['user_id']),
                        builder: (context, snapshot) {
                          var comment = widget.recipesComment.docs[i];
                          return Padding(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            widget.recipesComment.docs[i]['date'].toDate().toString().substring(0, 10),
                                            style: MizzUpTheme.bodyText1.override(
                                              color: Colors.black,
                                              fontFamily: 'IBM',
                                              fontSize: 12,
