            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(20, 10, 4, 20),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          child: Padding(
                            ...
                            child: FutureBuilder<List<RecettesRecord?>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<RecettesRecord?>
                                    pageViewRecettesRecordList = snapshot.data!;
                                return SizedBox(
                                  width: double.infinity,
                                  height:
                                                                    ...
                                                                    MaterialPageRoute(
                                                                      builder:
                                                                          (context) =>
                                                                              RecetteSuite2Widget(
                                                                        description:
                                                                            pageViewRecettesRecord.description!,
                                                                        dureePrepa:
                                                                            pageViewRecettesRecord.dureePrepa!,
                                                                        etapes:
                                                                            pageViewRecettesRecord.etapes!,
                                                                        listeIngredients:
                                                                            pageViewRecettesRecord.listeIngredients!,
                                                                        niveauDifficulte:
                                                                            pageViewRecettesRecord.niveauDifficulte!,
                                                                        photoPrincipale:
                                                                            pageViewRecettesRecord.photoPrincipale!,
                                                                        titre: pageViewRecettesRecord
                                                                            .titre!,
                                                                        nbIngredients:
                                                                            pageViewRecettesRecord.nbIngredients!,
                                                                        recetteRef:
                                                                            pageViewRecettesRecord.reference!,
                                                                      ),
                                                                    ),
                    ...
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(0, 20, 10, 20),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                                  ...
                                  await Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) => RecetteSuiteWidget(
                                        ...
                                        recetteVisibleRef:
                                            RecetteRef.shampoingVisibleName, recetteListImages: RecetteRef.shampoingListImages,
                                      ),
                                    ),
                                            ...
                                            onTap: () async {
                                              await Navigator
                                                ...
                                                MaterialPageRoute(
                                                  builder: (context) =>
                                                      RecetteSuiteWidget(
                                                    recetteRef: RecetteRef
                                                        .masqueHydratant,
                                                    recetteVisibleRef: RecetteRef
                                                        .masqueHydratantVisibleName, recetteListImages: RecetteRef.masqueHydratantListImages,
                                                  ),
                                                ),
                                                ...
                                                MaterialPageRoute(
                                                  builder: (context) =>
                                                    ...
                                                    recetteRef: RecetteRef
                                                        .masqueNourissant,
                                                    recetteVisibleRef: RecetteRef
                                                        .masqueNourissantVisibleName, recetteListImages: RecetteRef.masqueNourissantListImages,
                                                  ),
                                                ),
                                              ...
                                              await Navigator
                                                ...
                                                MaterialPageRoute(
                                                  builder: (context) =>
                                                    ...
                                                    recetteVisibleRef:
                                                        RecetteRef
                                                            .masqueProteine, recetteListImages: RecetteRef.masqueProteineListImages,
                                                  ),
                                                ),
                                ...
                                await Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => RecetteSuiteWidget(
                                      ...
                                      recetteVisibleRef:
                                          RecetteRef.gelVisibleName, recetteListImages: RecetteRef.gelListImages,
                                    ),
                                  ),
                                ...
                                await Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => RecetteSuiteWidget(
                                      ...
                                      recetteVisibleRef:
                                          RecetteRef.leaveInVisibleName, recetteListImages: RecetteRef.leaveInListImages,
                                    ),
                                  ),
                                ...
                                await Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => RecetteSuiteWidget(
                                      ...
                                      recetteVisibleRef:
                                          RecetteRef.sprayLotionVisibleName, recetteListImages: RecetteRef.sprayLotionListImages,
                                    ),
                                  ),
                                ...
                                await Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => RecetteSuiteWidget(
                                        ...
                                        recetteVisibleRef:
                                            RecetteRef.rincageVisibleName, recetteListImages: RecetteRef.rincageListImages,),
                                  ),
                                ...
                                await Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => RecetteSuiteWidget(
                                      ...
                                      recetteVisibleRef:
                                          RecetteRef.gommageVisibleName, recetteListImages: RecetteRef.gommageListImages,
                                    ),
                                  ),
