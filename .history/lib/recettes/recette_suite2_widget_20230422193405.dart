                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              TextButton(
                                                ...
                                                child: Icon(Icons.favorite_border, color: MizzUpTheme.primaryColor),
                                              ),
                                            ],
                                          )
                                        ],
...
Future<void> likeComment(String commentId) async {
  await FirebaseFirestore.instance.collection('comments').doc(commentId).update({'likes': FieldValue.increment(1)});
}
