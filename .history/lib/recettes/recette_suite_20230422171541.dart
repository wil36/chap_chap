                ...
                StreamBuilder(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      ...
                      List<Map<String, dynamic>> documents = snapshot.data!.docs as List<Map<String, dynamic>>;
                      for (Map<String, dynamic> doc in documents) {
                        ...
                        if (favRecipe.contains(streamPremium.reference!)) {
                          likesCounter++;
                          if (usersInitials.length < 3 && doc.containsKey('Nom') && doc.containsKey('Prenom')) {
                            String firstNameInitials = doc['Prenom'].toString().toUpperCase()[0];
                            String lastNameInitials = doc['Nom'].toString().toUpperCase()[0];
