                                                ...
                                                StreamBuilder(
                                                    ...
                                                    builder: ((context, snapshot) {
                                                      if (snapshot.hasData) {
                                                        ...
                                                        return Text(replies.length > 1 ? '${replies.length} réponses' : '${replies.length} réponse',
                                                            style: MizzUpTheme.bodyText1.override(color: MizzUpTheme.primaryColor, fontSize: 12, fontWeight: FontWeight.w300));
