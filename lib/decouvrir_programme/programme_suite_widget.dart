              ...
              return Container(
                ...
                child: StreamBuilder<DetailsWeekProgRecord?>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final lienPousse = detailsWeekDetailsWeekProgRecord!.texte1!
                        .replaceAll('\\n', '\n');
                    return Container(
                      width: double.infinity,
                      decoration: const BoxDecoration(),
                      child: StreamBuilder<ProgUserRecord?>(
                        stream: ProgUserRecord.getDocument(
                            widget.detailsProgUser.reference!),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            return const Center(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child:  Image.network( detailsProgProgrammesRecord
                                              .imagePrincipale!,
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                  ...
                                  Padding(
                                    ...
                                    child: StreamBuilder<List<ArticlesRecord?>>(
                                      stream: queryArticlesRecord(
                                        queryBuilder: (articlesRecord) =>
                                            articlesRecord.where('Titre',
                                                isEqualTo:
                                                    'Stimuler la pousse de ses cheveux grâce à la méthode de l\'inversion'),
                                        singleRecord: true,
                                      ),
                                      builder: (context, snapshot) {
                                        // Customize what your widget looks like when it's loading.
                                   ...
                                   if (detailsWeekDetailsWeekProgRecord
                                      .titreEtape3!
                                      .startsWith(
                                          RegExp('Faire un gommage du cuir'))) ...{
                                    Padding(
                                      padding:
                                          const EdgeInsetsDirectional.fromSTEB(
                                              20, 20, 10, 50),
                                  ...
                                  StreamBuilder<RecettesRecord?>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return Container(
                                        ...
                                        decoration: const BoxDecoration(),
                                        child: Visibility(
                                          visible: (containerRecettesRecord
                                                  ?.titre) !=
                                              'facultative',
                                          child: Column(
                                            mainAxisSize: MainAxisSize.max,
                                                          ...
                                                          child: ToggleIcon(
                                                            onPressed:
                                                              ...
                                                              final favorisRecettesElement =
                                                                  containerRecettesRecord
                                                                      .reference;
                                                              final favorisRecettesUpdate = programmeSuiteUsersRecord
                                                                      .favorisRecettes!
                                                                      .toList()
                                                                      .contains(
                                                              ...
                                                              await programmeSuiteUsersRecord
                                                                  .reference!
                                                                  .update(
                                                                      usersUpdateData);
                                                            },
                                                            value: programmeSuiteUsersRecord!
                                                                .favorisRecettes!
                                                                .toList()
                                                                .contains(
                                                                    containerRecettesRecord
                                                ...
                                                FFButtonWidget(
                                                  onPressed: () async {
                                                    await Navigator.push(
                                                      ...
                                                      MaterialPageRoute(
                                                        builder: (context) =>
                                                             RecetteSuiteWidget(recetteRef: RecetteRef.masqueHydratant, recetteVisibleRef: RecetteRef.masqueHydratantVisibleName, recetteListImages: RecetteRef.masqueHydratantListImages,),
                                                      ),
                                                    );
                                                  },
                                                ...
                                                FFButtonWidget(
                                                  onPressed: () async {
                                                    await Navigator.push(
                                                      ...
                                                      MaterialPageRoute(
                                                        builder: (context) =>
                                                             RecetteSuiteWidget(recetteRef: RecetteRef.sprayLotion, recetteVisibleRef: RecetteRef.sprayLotionVisibleName, recetteListImages: RecetteRef.sprayLotionListImages,),
                                                      ),
                                                    );
                                                ...
                                                FFButtonWidget(
                                                  onPressed: () async {
                                                    await Navigator.push(
                                                      ...
                                                      MaterialPageRoute(
                                                        builder: (context) =>
                                                             RecetteSuiteWidget(recetteRef: RecetteRef.leaveIn, recetteVisibleRef: RecetteRef.leaveInVisibleName, recetteListImages: RecetteRef.leaveInListImages,),
                                                      ),
                                                    );
                                                  },
                                                ...
                                                FFButtonWidget(
                                                  onPressed: () async {
                                                    await Navigator.push(
                                                      ...
                                                      MaterialPageRoute(
                                                        builder: (context) =>
                                                             RecetteSuiteWidget(recetteRef: RecetteRef.gel, recetteVisibleRef: RecetteRef.gelVisibleName, recetteListImages: RecetteRef.gelListImages,),
                                                      ),
                                                    );
                                                  },
                                                  text: 'Voir les Gels',
