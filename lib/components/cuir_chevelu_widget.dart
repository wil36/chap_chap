...
class CuirCheveluWidget extends StatefulWidget {
  const CuirCheveluWidget({Key? key}) : super(key: key);

  @override
  _CuirCheveluWidgetState createState() => _CuirCheveluWidgetState();
}

class _CuirCheveluWidgetState extends State<CuirCheveluWidget> {
