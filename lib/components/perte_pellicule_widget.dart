...
class PertePelliculeWidget extends StatefulWidget {
  const PertePelliculeWidget({Key? key}) : super(key: key);

  @override
  _PertePelliculeWidgetState createState() => _PertePelliculeWidgetState();
}

class _PertePelliculeWidgetState extends State<PertePelliculeWidget> {
                ...
                children: [
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        'As-tu des problèmes de pellicules ?',
