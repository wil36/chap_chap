...
class AddRecette2Widget extends StatefulWidget {
  const AddRecette2Widget({
    Key? key,
  ...
  @override
  _AddRecette2WidgetState createState() => _AddRecette2WidgetState();
}

class _AddRecette2WidgetState extends State<AddRecette2Widget> {
  String? searchKey;
