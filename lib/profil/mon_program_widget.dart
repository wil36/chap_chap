...
class _MonProgramWidgetState extends State<MonProgramWidget> {
  ...
  DocumentReference semaineSpecial4 =
      FirebaseFirestore.instance.collection('programmes').doc('decouverte');
  List<Alternative> alternatives = [];
  bool isloading = true;

  @override
  void initState() {
    getAlternativesForRecipe().then((value) {
      if (mounted) {
        setState(() {
          print(value);
          alternatives = value;
  ...
  Future<List<Alternative>> getAlternativesForRecipe() async {
    List<Alternative> alternatives = [];
    ...
    if (currentUserDocument?.progRef == semaineSpecial1) {
    ...
    } else if (currentUserDocument?.progRef == semaineSpecial2) {
      final querySnapshot = await FirebaseFirestore.instance
          .collection('programmes')
          .doc('BFUA4QdhoxRMdAReXPyh')
          .get();
      alternatives = List<Alternative>.from(
          (valueOrDefault(querySnapshot.data()!['alternatives'], {})
                  as List<dynamic>)
              .map((e) => Alternative.fromJson(e)));
    } else if (currentUserDocument?.progRef == semaineSpecial3) {
      final querySnapshot = await FirebaseFirestore.instance
          .collection('programmes')
          .doc('TMqv6WGZkkMDh6nik4JB')
          .get();
      alternatives = List<Alternative>.from(
          (valueOrDefault(querySnapshot.data()!['alternatives'], {})
                  as List<dynamic>)
              .map((e) => Alternative.fromJson(e)));
    } else if (currentUserDocument?.progRef == semaineSpecial4) {
      final querySnapshot = await FirebaseFirestore.instance
          .collection('programmes')
          .doc('decouverte')
          .get();
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          if (columnProgrammesRecord.duree ==
                                              100) ...{
                                            Text(
                          ...
                          AuthUserStreamWidget(
                            child: StreamBuilder<ProgrammesRecord?>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                print("object " + alternatives.toString());
                                final columnProgrammesRecord = snapshot.data;
                                final textDescription = columnProgrammesRecord!
                                    .description!
                                    .replaceAll('\\n', '\n');
                        ...
                        if (currentUserDocument?.progRef == semaineSpecial4)
                          AuthUserStreamWidget(
                            child: StreamBuilder<ProgrammesRecord?>(
                              stream: ProgrammesRecord.getDocument(
                                  currentUserDocument!.progRef!),
