                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(0, 20, 15, 0),
                        child: StreamBuilder<List<UsersRecord?>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return Builder(
                              builder: (context) {
                                final favoriteRecettes = rowUsersRecord!
                                    .favorisRecettes!
                                    .toList()
                                    .toList();
                                ...
                                return SingleChildScrollView(
                                  ...
                                  child: Row(
                                    ...
                                    children:
                                        List.generate(favoriteRecettes.length,
                                                          ...
                                                          child: ToggleIcon(
                                                            onPressed:
                                                              ...
                                                              final favorisRecettesElement =
                                                                  columnRecettesRecord
                                                                      .reference;
                                                              final favorisRecettesUpdate = rowUsersRecord
                                                                      .favorisRecettes!
                                                                      .toList()
                                                                      .contains(
                        ...
                        child: Padding(
                          ...
                          child: StreamBuilder<List<UsersRecord?>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return Builder(
                                builder: (context) {
                                  final favoriteArticles = rowUsersRecord!
                                      .favorisArticles!
                                      .toList()
                                      .toList();
                                  ...
                                  return SingleChildScrollView(
                                    ...
                                    child: Row(
                                      ...
                                      crossAxisAlignment:
                                          CrossAxisAlignment.start,
                                      children:
                                          List.generate(favoriteArticles.length,
                                                            ...
                                                            child: ToggleIcon(
                                                              onPressed:
                                                                ...
                                                                final favorisArticlesElement =
                                                                    columnArticlesRecord
                                                                        .reference;
                                                                final favorisArticlesUpdate = rowUsersRecord
                                                                        .favorisArticles!
                                                                        .toList()
                                                                        .contains(
