...
class MizzUpCountController extends StatefulWidget {
  const MizzUpCountController({
    Key? key,
  ...
  @override
  _MizzUpCountControllerState createState() => _MizzUpCountControllerState();
}

class _MizzUpCountControllerState extends State<MizzUpCountController> {
