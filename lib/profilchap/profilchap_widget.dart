              ...
              children: [
                Column(
                  ...
                  children: [
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(0, 40, 20, 20),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(10, 0, 0, 20),
                        child: Text(
                          'Question 1 sur 6',
                ...
                Align(
                  ...
                  child: Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(20, 0, 20, 50),
                    child: AuthUserStreamWidget(
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: 'Par quel prénom doit-on t\'appeler ?',
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Profilchap2Widget(),
                        ),
                      );
                    },
                    text: 'Valider',
