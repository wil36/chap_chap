...
import 'profilchap3_widget.dart';
import 'package:flutter/material.dart';

class Profilchap2Widget extends StatefulWidget {
  const Profilchap2Widget({Key? key}) : super(key: key);

  @override
  _Profilchap2WidgetState createState() => _Profilchap2WidgetState();
}
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Profilchap3Widget(),
                          ),
                        );
                      },
                      text: 'Valider',
